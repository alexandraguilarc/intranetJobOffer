...
class JoboffersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create joboffer" do
    assert_difference("Joboffer.count") do
      post joboffers_url, params: { joboffer: { departament: @joboffer.departament, description: @joboffer.description, position: @joboffer.position, user_id: @joboffer.user_id, when_went: @joboffer.when_went } }
    end
  ...
  test "should update joboffer" do
    patch joboffer_url(@joboffer), params: { joboffer: { departament: @joboffer.departament, description: @joboffer.description, position: @joboffer.position, user_id: @joboffer.user_id, when_went: @joboffer.when_went } }
